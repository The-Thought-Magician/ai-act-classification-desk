    ...
    <main className="min-h-screen bg-stone-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-1 text-sm text-stone-400">EU AI Act compliance workbench</p>
        </div>
        <form onSubmit={handleSubmit} className="bg-stone-900 rounded-xl border border-stone-800 p-8 space-y-4">
          ...
          <div>
            ...
            <input name="password" type="password" required className="w-full bg-stone-800 border border-stone-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-rose-500" />
          </div>
